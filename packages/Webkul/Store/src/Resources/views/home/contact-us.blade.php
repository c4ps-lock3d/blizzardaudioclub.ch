...
<x-shop::layouts>
    ...
    <div class="container mt-8 max-1180:px-5 max-md:mt-6 max-md:px-4">
        <!-- Form Container -->
		<div id="backgroundCard" class="m-auto w-full max-w-[870px] rounded-xl border border-black p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
