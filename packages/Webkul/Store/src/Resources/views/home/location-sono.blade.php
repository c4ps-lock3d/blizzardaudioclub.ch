...
<x-shop::layouts>
    ...
    <div class="container px-[60px] max-lg:px-8 max-md:px-4">
        ...
        <p>Intéressé(e) ? <a class="!text-[#FFD940]" href="{{ route('shop.home.contact_us') }}">contactez-nous via notre formulaire</a>.</p>
