...
<x-shop::layouts>
    ...
    <div class="container px-[60px] max-lg:px-8 max-md:px-4">
        ...
        Blizzard Audio Club est un label indépendant de musique à tendances électroniques créé autour de l'ambition de sortir des disques, cassettes et autres supports sonores en tout genre. Le label fondé à la Chaux-de-Fonds a aussi pour vocation d'être une aide pour les artistes dans la production de leurs œuvres ainsi qu'une plateforme de promotion et de visibilité́ pour ces dernières, au travers d’un travail de communication pointu et de l’organisation d’événements. Riche de plus de 40 sorties depuis sa création, le label compte dans ses rangs les artistes suivant·e·s :
        @foreach($artistes as $artiste)
            ...
            @endif
        @endforeach
        <br><br>Il est ici important de relever le fait que le label a toujours mis un point d’honneur à défendre la scène musicale suisse et régionale, comme le prouve sa liste d'artistes, tout en leur permettant un rayonnement dans leur pays mais aussi à l'international. En effet, le permet aux groupes qu'il soutient de se faire un nom sur la scène suprarégionale mais aussi de toucher un plus large public, hors des frontières, grâce large au tissu professionnel de partenaires qu'il a développé.<br><br>
