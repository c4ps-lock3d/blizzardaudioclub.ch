...
<x-shop::layouts>
    ...
    <div class="container mt-[34px] px-[60px] max-lg:px-8 max-md:mt-4 max-md:px-4 max-md:text-sm max-sm:text-xs">
        <p class="text-xl">BAC+5</p>
    </div>

    <div class="container px-[60px] max-lg:px-8 max-md:px-4">
        <p class="mt-6 text-justify">
            Depuis 2018, Blizzard Audio Club a toujours eu à coeur de promouvoir, accompagner et développer la carrière d'artistes de la scène des musiques actuelles suisses.<br><br>
            Et oui, 7 ans déjà ! L'équipe BAC a voulu fêter ce beau tournant avec un max de monde, à travers la tournée BAC+5 (oui, léger décalage de calendrier 😉 ).
        </p>
<div class="bg-[#343a40] rounded-xl shadow-lg p-6 max-w-2xl mx-auto mt-8">
