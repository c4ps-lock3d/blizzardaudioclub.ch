<div id="backgroundShimmer" class="panel-side journal-scroll grid max-h-[1320px] min-w-[342px] max-w-[400px] grid-cols-[1fr] overflow-y-auto overflow-x-hidden max-xl:min-w-[270px] ltr:pr-7 rtl:pl-7">
    ...
    <div class="border-b border-zinc-200">
        ...
        <div class="z-10 grid rounded-lg pb-3">
