        ...
        <div>
            ...
            <div class="flex justify-between max-md:hidden">
                ...
                >
                    <x-slot:toggle>
                        <!-- Dropdown Toggler -->
                        <button class="flex w-full max-w-[200px] cursor-pointer items-center justify-between gap-4 rounded-lg border border-black p-3.5 text-base transition-all hover:border-gray-400 focus:border-gray-400 max-md:w-[110px] max-md:border-0 max-md:pl-2.5 max-md:pr-2.5">
                    ...
                    <x-slot:menu>
                        <x-shop::dropdown.menu.item
                            ...
                            ::class="{'bg-[#1d2124]': sort.value == filters.applied.sort}"
                    ...
                    <x-shop::dropdown position="bottom-right">
                        ...
                        <x-slot:menu>
                            <x-shop::dropdown.menu.item
                                ...
                                ::class="{'bg-[#1d2124]': limit == filters.applied.limit}"
